...
|------|----------|--------|
| Simon - Professional Voice | `ad8953005ca644e588c0c7e7e99c1bce` | ElevenLabs clone |

## Avatar Group

- **Group ID:** `16f1057f84bd43b695749582ca09978f`
- **Name:** Simon Coton
...
| # | Name | Avatar ID |
|---|------|-----------|
| 1 | Simon Coton | `1d97d7482dc44cf79ba5312aa7bb90d9` |
| 2 | Simon Coton -- 5 | `ed9879b9f83348beb42aa2ff7bdaddee` |
| 3 | Simon Coton -- 6 | `2b92dc8132e746558f034ea6e86a11be` |
...
- **Default look:** 3 (Simon Coton -- 6)
- **Default style:** normal
- **Rotation:** Cycle through looks 1 → 2 → 3 → 1 sequentially per video
