...
description: >
  ...
  Does NOT trigger for brand token extraction — that is mkt-design-tokens.
---
...
- Applies brand design tokens from `{brand_context}/design-tokens.md`
...
|------|-----------|---------|
| `{brand_context}/design-tokens.md` | full | Colours, typography, spacing, CSS vars |
...
3. Brand tokens from `{brand_context}/design-tokens.md` if available.
...
- Brand tokens (from `{brand_context}/design-tokens.md` or inline)
...
If `{brand_context}/design-tokens.md` exists, override preset colours and typography with brand tokens. The preset provides layout and animation feel; the brand provides visual identity.
