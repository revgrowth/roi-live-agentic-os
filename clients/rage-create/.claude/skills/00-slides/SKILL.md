...
| `{brand_context}/design-tokens.md` | full | Pass to viz-frontend-slides |
...
Also check for `{brand_context}/design-tokens.md`. If missing, offer to run `mkt-design-tokens` or proceed with neutral defaults.
...
- Brand tokens (from `{brand_context}/design-tokens.md`)
...
| `mkt-design-tokens` | Optional | Brand visual tokens | Uses neutral defaults |
