...
- `brand_context/design-tokens.md` — if you want branded PDF styling (fonts, colours, accents)
...
- **branded** — uses your `brand_context/design-tokens.md` for fonts, colours, and layout
...
- [ ] Optional: `brand_context/design-tokens.md` for branded PDF styling
