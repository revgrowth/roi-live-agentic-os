# Blue Tree Landscaping_ Complete Website Sitemap Phased Implementation Plan v2.2.md

# Blue Tree Landscaping: Complete Website Sitemap & Phased Implementation Plan — v2.2

## Revision Notes

### v2.2 Changes (2026-05-12)

**What changed from v2.1:** Mechanical errata resolution from Blue Tree onboarding Phase 4. Source: `clients/blue-tree/context/errata-consolidated.md` (S1-S4).

1. **"Healthy Yard" → "Healthy Yards"** — All references corrected to plural per voice-profile v1.2 §10.4. Affects pillar URL, operation tag, navigation label, cluster URL references.
2. **Sprinkler System Installation cluster removed** — Per voice-profile v1.2 §10.2 and Client Feedback Master Reference §4 (Maureen Mattiola, Feb 18 2026). Launch cluster count drops from 29 to 28; total launch page count drops from 80 to 79.
3. **Jeff Mattiola URL corrected** — `/about/team/jeff-downie/` → `/about/team/jeff-mattiola/`. Author bio surname is Mattiola, not Downie.
4. **Mark Peasley spelling corrected** — "Mark Paisley" → "Mark Peasley". URL slug updated accordingly.

Total launch page count: 79 (was 80). Composition: 20 core + 5 pillars + 28 service clusters + 5 counties + 12 Tier 1 towns + 9 Tier 2 towns.

S5 (Spa & Hot Tub Integration scope) remains open pending Maureen + Jérôme client ruling.
* * *
...
1. **Service pillars consolidated from 9 → 5** (Pools, Landscapes, Hardscapes, Healthy Yards, Premier Outdoor Services)
...
| Healthy Yards | Portfolio, Reviews, Team, Blogs, FAQs, Warranties, Instructions, Careers |
...
| ---| ---| ---| --- |
| 12a | Jeff Mattiola Bio | `/about/team/jeff-mattiola/` | Author: pool, leadership, pricing, budgeting content |
...
| 12d | Mark Peasley Bio | `/about/team/mark-peasley/` | Author: turf care, lawn, pest control, Healthy Yards content |
...
> **Page Count Note:** Author bio pages and Editorial Standards are counted separately from the 20 core pages. These launch alongside the first 5 blog posts and do not count against the 79-page launch cap.
...
| 4 | Healthy Yards | `/healthy-yards/` | Turf care programs, pest control, drainage solutions, weed management, and sport field care |
...
### 📁 SERVICE CLUSTER PAGES (28 pages)
* * *
...
#### **Landscapes Cluster** (`/landscapes/...`) — 7 pages
...
#### **Healthy Yards Cluster** (`/healthy-yards/...`) — 4 pages

| # | Page | URL Slug | New/Existing |
| ---| ---| ---| --- |
| 1 | Lawn Fertilization Programs | `/healthy-yards/fertilization/` | Existing |
| 2 | Aeration & Overseeding | `/healthy-yards/aeration-overseeding/` | Existing |
| 3 | Weed Control Services | `/healthy-yards/weed-control/` | Existing |
| 4 | Mosquito & Tick Control | `/healthy-yards/mosquito-tick-control/` | Existing |
...
| 12 | When to Aerate Your Lawn in PA | `/blog/when-to-aerate-lawn-pa/` | Healthy Yards | ⏳ Month 6 |
| 13 | Mosquito Control Tips for PA Homeowners | `/blog/mosquito-control-tips-pa/` | Healthy Yards | ⏳ Month 7 |
...
#### Service Cluster Pages (28 pages — pages 26–53)
...
| ---| --- |
| 41 | Hardscape Design |
| 42 | Paver Patio Design & Installation |
| 43 | Outdoor Kitchens |
| 44 | Fire Pits & Fireplaces |
| 45 | Walkways & Pathways |
| 46 | Retaining Walls |
| 47 | Backyard Oasis Design |

**Healthy Yards Cluster — 4 pages:**

| # | Page |
| ---| --- |
| 48 | Lawn Fertilization Programs |
| 49 | Aeration & Overseeding |
| 50 | Weed Control Services |
| 51 | Mosquito & Tick Control |

**Premier Outdoor Services Cluster — 2 pages:**

| # | Page |
| ---| --- |
| 52 | Pool Service & Maintenance |
| 53 | Year-Round Maintenance Packages |

* * *

#### County Pages (5 pages — pages 54–58)
...
| 56 | Chester County |
| 57 | Delaware County |
| 58 | Philadelphia County |

* * *

#### Tier 1 Location Pages — Golden Circle (12 pages — pages 59–70)
...
#### Tier 2 Location Pages — Main Line (9 pages at launch — pages 71–79)
...
**LAUNCH TOTAL: 79 PAGES** ✅
* * *

#### E-E-A-T Support Pages (launch alongside blog content — not counted against 79-page cap)

| Page | URL |
| ---| --- |
| Jeff Mattiola Bio | `/about/team/jeff-mattiola/` |
| Jérôme Besnard Bio | `/about/team/jerome-besnard/` |
| \[Lead Designer\] Bio | `/about/team/[name]/` |
| Mark Peasley Bio | `/about/team/mark-peasley/` |
...
| 119 | Drainage & Grading Solutions | Healthy Yards Cluster |
...
| 126 | Turf Renovation & Restoration | Healthy Yards Cluster |
| 127 | Sport Field Care | Healthy Yards Cluster |
...
| 136 | Organic Lawn Care | Healthy Yards Cluster |
| 137 | Soil Testing & Amendment | Healthy Yards Cluster |
...
├── Healthy Yards (pillar) → Fertilization, Aeration, Weed Control, Pest Control
...
| Mosquito & Tick Control (pillar) | Absorbed into Healthy Yards cluster |
...
| Irrigation System Repair (cluster) | Removed from launch scope (Sprinkler System Installation cluster removed in v2.2 per v1.1 §10.2; drip irrigation remains the supported service) |
...
3. **Content briefs for all 28 launch cluster pages** — Begin with 5 pillar pages, then cluster pages by revenue priority
...
_Document version: v2.2_
_Created: February 19, 2026 (v2.1) — revised 2026-05-12 (v2.2)_
_Author:_ [_ROI.LIVE_](http://ROI.LIVE)
_Client: Blue Tree Landscaping | Contact: Jérôme Besnard (Sales Manager)_
_Previous versions: v2.0 (February 18, 2026), v2.1 (February 19, 2026)_

**v2.2 Change Summary:**

*   "Healthy Yard" singular → "Healthy Yards" plural (pillar URL, operation tag, navigation label, cluster URL references)
*   Sprinkler System Installation cluster removed (v1.1 §10.2 ban; service not offered)
*   Jeff Mattiola URL corrected (`/about/team/jeff-mattiola/`)
*   Mark Peasley spelling corrected
*   Launch total revised from 80 to 79 pages; cluster count from 29 to 28
