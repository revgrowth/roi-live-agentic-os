---
clickup_doc_id: 8cma26h-13593
clickup_page_id: 8cma26h-5093
clickup_url: https://app.clickup.com/9013889233/docs/8cma26h-13593/8cma26h-5093
original_filename: Sitemap v2
normalized_title: sitemap
classification: REFERENCE_DOC
version: v2
status_in_archive: canonical
date_updated: 2026-02-18
hierarchy_category: Blue Tree Landscaping
hierarchy_subcategory: 2026 New Website (task 86aex94bp)
md5: 476afaf56f85932bae208dde94ca3990
archived_to_repo: 2026-05-12
---

# Blue Tree Landscaping: Complete Website Sitemap & Phased Implementation Plan — v2
...
1. **Service pillars consolidated from 9 → 5** (Pools, Landscapes, Hardscapes, Healthy Yard, Outdoor Concierge)
2. **"Operation Tags"** introduced for cross-pillar filtering at the navigation level — visitors can filter portfolio, reviews, team, jobs, blogs, FAQs, warranties, and instructions by service pillar
3. **"Service Hub"** section added (Warranties, FAQs, Care Instructions) — replaces scattered trust pages
4. **Meet the Team** restructured with department tags (Design, Project Managers, Support, Leadership, Marketing)
...
| Outdoor Concierge | Portfolio, Reviews, Team, Blogs, FAQs, Warranties, Instructions, Careers |
...
| 2 | Portfolio — Photo Gallery | `/portfolio/` | Visual proof, filterable by operation tag |
| 3 | Portfolio — Completed Projects | `/portfolio/completed-projects/` | Case studies with before/after + scope details |
...
| 5 | Outdoor Concierge | `/outdoor-concierge/` | Ongoing maintenance, pool service, paver restoration, clean-ups, bed maintenance, and pruning |

**Service Pillar Pages Total: 5**
* * *

### 📁 SERVICE CLUSTER PAGES (55 pages)
* * *

#### **Pools Cluster** (`/pools/...`) — 13 pages
...
| 4 | Pool Water Features | `/pools/water-features/` | ✅ Pool features | Existing |
| 5 | Pool Lighting | `/pools/pool-lighting/` | ✅ Pool features — Lighting | Existing |
| 6 | Concrete Pool Installation | `/pools/concrete-pools/` | — | Existing |
| 7 | Grottos & Caves | `/pools/grottos/` | — | Existing |
| 8 | Waterfalls & Cascades | `/pools/waterfalls/` | — | Existing |
| 9 | Sheer Descent Water Features | `/pools/sheer-descents/` | — | Existing |
| 10 | Pool Slides | `/pools/pool-slides/` | — | Existing |
| 11 | Pool Decking & Coping | `/pools/pool-decking/` | — | Existing |
| 12 | Spa & Hot Tub Integration | `/pools/spa-hot-tub/` | — | Existing |
| 13 | Pool Equipment (Jandy) | `/pools/pool-equipment/` | — | Existing |

* * *

#### **Landscapes Cluster** (`/landscapes/...`) — 14 pages

_Now includes lighting and irrigation sub-services that were previously standalone pillars._

| # | Page | URL Slug | Client Request | New/Existing |
| ---| ---| ---| ---| --- |
| 1 | Landscape Design Services | `/landscapes/design/` | ✅ Landscape design | Existing |
| 2 | Garden Design & Planting | `/landscapes/garden-design/` | ✅ Planting | Existing |
| 3 | Native Plant Landscaping | `/landscapes/native-plants/` | — | Existing |
| 4 | Foundation Planting | `/landscapes/foundation-planting/` | — | Existing |
| 5 | Privacy Screening & Hedges | `/landscapes/privacy-screening/` | — | Existing |
| 6 | Shade Tree Installation | `/landscapes/shade-trees/` | — | Existing |
| 7 | Seasonal Color & Annuals | `/landscapes/seasonal-color/` | — | Existing |
| 8 | Mulching Services | `/landscapes/mulching/` | — | Existing |
| 9 | Fencing | `/landscapes/fencing/` | ✅ Landscaping features — Fencing | NEW |
| 10 | LED Landscape Lighting | `/landscapes/led-lighting/` | ✅ LED lighting | Restructured (was `/landscape-lighting/`) |
| 11 | Pathway & Accent Lighting | `/landscapes/pathway-accent-lighting/` | ✅ Pathway & accent lighting | Restructured |
| 12 | Drip Irrigation | `/landscapes/drip-irrigation/` | ✅ Drip irrigation | Restructured (was `/irrigation/`) |
| 13 | Sprinkler System Installation | `/landscapes/sprinkler-systems/` | — | Restructured |
| 14 | Smart Irrigation Controllers | `/landscapes/smart-irrigation/` | — | Restructured |

* * *

#### **Hardscapes Cluster** (`/hardscapes/...`) — 13 pages
...
| 2 | Paver Patio Design & Installation | `/hardscapes/paver-patios/` | ✅ Patio | Existing |
...
| 8 | Driveways | `/hardscapes/driveways/` | — | Existing |
| 9 | Pergolas | `/hardscapes/pergolas/` | — | Existing |
| 10 | Gazebos | `/hardscapes/gazebos/` | — | Existing |
| 11 | Stone & Masonry Work | `/hardscapes/stone-masonry/` | — | Existing |
| 12 | Seat Walls & Built-In Seating | `/hardscapes/seat-walls/` | — | Existing |
| 13 | Pool Surrounds & Decks | `/hardscapes/pool-surrounds/` | — | Existing |

* * *

#### **Healthy Yard Cluster** (`/healthy-yard/...`) — 9 pages
...
| 2 | Aeration & Overseeding | `/healthy-yard/aeration-overseeding/` | ✅ Aeration and overseeding | Existing |
| 3 | Turf Renovation & Restoration | `/healthy-yard/turf-renovation/` | ✅ Turf renovation | Existing |
...
| 8 | Soil Testing & Amendment | `/healthy-yard/soil-testing/` | — | Existing |

* * *

#### **Outdoor Concierge Cluster** (`/outdoor-concierge/...`) — 6 pages
...
| # | Page | URL Slug | Client Request | New/Existing |
| ---| ---| ---| ---| --- |
| 1 | Pool Service & Maintenance | `/outdoor-concierge/pool-service/` | ✅ Pool services | Existing (moved) |
| 2 | Paver Restoration | `/outdoor-concierge/paver-restoration/` | ✅ Paver restoration | NEW |
| 3 | Yard Clean-Up Services | `/outdoor-concierge/yard-clean-ups/` | ✅ Yard clean-ups | Existing (consolidated spring + fall) |
| 4 | Bed Maintenance | `/outdoor-concierge/bed-maintenance/` | ✅ Bed maintenance | NEW |
| 5 | Pruning Services | `/outdoor-concierge/pruning/` | ✅ Pruning | NEW |
| 6 | Year-Round Maintenance Packages | `/outdoor-concierge/maintenance-packages/` | — | Existing (moved) |

* * *

**Service Cluster Pages Total: 55**
* * *
...
**TIER 2: Main Line & Affluent Outliers (12 towns)**
...
| # | Page | Priority Rationale |
| ---| ---| --- |
| 31 | Landscape Design Services | Primary landscape search term |
