---
clickup_doc_id: 8cma26h-16033
clickup_page_id: 8cma26h-7553
clickup_url: https://app.clickup.com/9013889233/docs/8cma26h-16033/8cma26h-7553
original_filename: BlueTree_Navigation_MegaMenu_CreativeBrief_v1.md
...
md5: 7b5e81158c5f10c46d86cf0eee332508
...
_Companion document to: Three-Phase Launch & Content Rollout Plan v1.0_
...
When Phase 1 Sprint 1 completes (29 cluster pages live), the nav upgrades from standard links to mega menu panels. This is the most visible change in the entire launch sequence.
...
**DEV NOTE:** Deploy the mega menu upgrade as a single coordinated change once all 29 cluster pages are live. Do not launch mega menu panels with partial content.
...
| M4–6 | Landscapes panel: +6 items (Foundation Planting, Privacy Screening, Shade Trees, Smart Irrigation, Seasonal Color, Mulching). Healthy Yard panel: +5 items (Drainage, Sport Field, Turf Renovation, Organic, Soil Testing). Premier panel: +3 (Yard Clean-Up, Bed Maintenance, Pruning). | Tier 3 remaining (6 towns), Tier 4 start (5 towns), 3 blog posts. |
...
| Sprinkler System Installation | /landscapes/sprinkler-systems/ | Full-coverage lawn irrigation | Phase 1 |
...
| Smart Irrigation Controllers | /landscapes/smart-irrigation/ | WiFi-enabled water management | Month 4 |
...
| Link Label | URL | Descriptor | Available |
| ---| ---| ---| --- |
| Lawn Fertilization Programs | /healthy-yard/fertilization/ | Multi-step feeding programs | Phase 1 |
| Aeration & Overseeding | /healthy-yard/aeration-overseeding/ | Core aeration and seed renovation | Phase 1 |
| Weed Control Services | /healthy-yard/weed-control/ | Pre- and post-emergent treatments | Phase 1 |
| Mosquito & Tick Control | /healthy-yard/mosquito-tick-control/ | Barrier spray programs | Phase 1 |
| Drainage & Grading | /healthy-yard/drainage/ | French drains and grading | Month 4 |
| Turf Renovation | /healthy-yard/turf-renovation/ | Full lawn rebuild and repair | Month 5 |
| Sport Field Care | /healthy-yard/sport-field-care/ | Athletic turf programs | Month 5 |
| Organic Lawn Care | /healthy-yard/organic-lawn-care/ | Chemical-free turf programs | Month 6 |
| Soil Testing & Amendment | /healthy-yard/soil-testing/ | pH and nutrient analysis | Month 6 |

### **Column 2 — Explore More**

**Healthy Yard Portfolio** → /portfolio/ (filtered by Healthy Yard tag)

**Healthy Yard Reviews** → /reviews/ (filtered by Healthy Yard tag)

**Healthy Yard FAQs** → /service-hub/faqs/ (filtered by Healthy Yard tag)

**Care Instructions** → /service-hub/instructions/ (filtered by Healthy Yard tag)
...
**Explore All Healthy Yard Programs →** /healthy-yard/
...
| Landscapes | Accordion: 8 cluster pages + “All Landscape Services” | Chevron |
| Hardscapes | Accordion: 7 cluster pages + “All Hardscape Services” | Chevron |
| Healthy Yard | Accordion: 4 cluster pages + “All Healthy Yard Programs” | Chevron |
