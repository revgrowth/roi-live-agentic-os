---
clickup_doc_id: 8cma26h-14053
clickup_page_id: 8cma26h-5553
clickup_url: https://app.clickup.com/9013889233/docs/8cma26h-14053/8cma26h-5553
...
md5: 30a1df301b8b8309b38a6a999bc9f2f4
...
> **Status:** 0 of 8 items resolved. All items pending client input.

| # | Item | Status | Resolution |
| ---| ---| ---| --- |
| 1 | Office Hours | ⏳ PENDING | What are Blue Tree's current office hours? Are they seasonal (longer hours spring/summer)? Is there a difference between office hours and field crew hours? Current assumption: Monday–Friday 7:00 AM – 5:00 PM, Saturday by appointment. Closed Sunday. Seasonal adjustment note included. |
| 2 | Form Submission Destination | ⏳ PENDING | Where should estimate request form submissions be routed? CRM system (which one?), email distribution list, or specific staff email? Does Jérôme or a specific sales coordinator receive and assign leads? Current assumption: Submissions route to a sales team inbox with auto-assignment. Brief includes recommended auto-reply specifications. |
| 3 | Financing Partner Details | ⏳ PENDING | The Financing page (`/financing/`) is a separate core page, but should the estimate form include a "Interested in financing?" checkbox or mention of financing options? Current assumption: Including a subtle financing mention in the trust bar below the form, with a link to `/financing/`. |
...
| 5 | Service Area Boundaries | ⏳ PENDING | Are there towns or areas where Blue Tree will not travel for a consultation? The brand voice guide specifies five counties, but are there outer boundaries within those counties? Current assumption: All five counties are served without restriction. |
...
| 7 | Phone System / Routing | ⏳ PENDING | Does (610) 222-0590 route to a receptionist, auto-attendant, or ring directly to the sales team? Understanding the phone experience helps us set correct expectations in the copy. Current assumption: Live receptionist during business hours. |
| 8 | Lead Source Tracking | ⏳ PENDING | Does the current CRM or intake process track lead source (how did you hear about us)? If so, should the form include a "How did you hear about us?" field? Current assumption: Including this as an optional field — it provides valuable attribution data. |
...
| Design team | 6 degreed landscape designers (Penn State, Rutgers, Temple, Penn College) | Live site bios |
...
*   The "New Project Estimate" and "Healthy yard & turf care" cards should be visually dominant (larger, accent color, first position)
...
A: You can reach Blue Tree at **(610) 222-0590** during business hours, Monday through Friday, 9:00 AM to 5:00 PM. Saturday and Sunday - closed.
* * *

**Q: Where is Blue Tree located?**
A: Blue Tree is headquartered at 4494 Skippack Pike, Schwenksville, PA 19473 — located in Skippack Township, Montgomery County. We serve homeowners throughout Southeastern PA, including Montgomery, Bucks, Chester, Delaware, and Philadelphia Counties. [View our service areas →](http:///service-areas/montgomery-county/)
* * *

**Q: How do I request a free estimate from Blue Tree?**
A: Visit our [Request an Estimate](http:///request-estimate/) page and tell us about your project. One of our degreed designers will contact you within one business day to schedule a free on-site consultation at your property.
* * *
...
| Breadcrumb | `Home > Request an Estimate` |
| H1 | Request Your Free Design Consultation |
| Subheadline | Tell us about your project and one of our designers will reach out to you within two business days to schedule a free on-site visit. No cost. No obligation. Just honest feedback from professionals who've been doing this since 1983. |
...
| Services Interested In | Multi-checkbox | Yes (at least 1) | What services are you interested in? | ☐ Pool Design, Construction and renovation · ☐ Landscape Design & Installation · ☐ Hardscapes (Patios, Outdoor Kitchens, Fire Features) · ☐ Healthy Yard (Lawn Care, Pest Control) · ☐ Outdoor Maintenance · ☐ I'm Not Sure Yet — Help Me Decide |
...
| Estimated budget | Dropdown | No | What is your budget? | Under $1k<br>$1k-$5k<br>$5k-$10k<br>$10k-$25k<br>$25k-$50k<br>$50k-$100k<br>$75k-$100k<br>Over $100k |
| How Did You Hear About Us? | Dropdown | No | How did you hear about Blue Tree? (optional) | Options: Google Search · Referral from Friend/Neighbor · Saw Our Work in the Neighborhood · Social Media · Houzz · Home Show/Event · Drove Past a Job Site · Other |
...
> Or call us directly: **(610) 222-0590** — Monday–Friday, 9:00 AM – 5:00 PM
* * *
...
*   **"Estimated Timeline", "estimate budget" and "How Did You Hear About Us?" are optional** — they provide valuable sales intelligence without blocking conversion.
...
**Headline:** Thank You — Your Consultation Request Has Been Received. We will contact you shortly.

**Body:**

Here's what happens next:

1. **Within two business days**, one of our designers will reach out to you via your preferred contact method to schedule your free on-site visit.
...
| ---| ---| ---| --- |
| 1 | Calendar | We Schedule a Visit | After you submit your request, a designer will contact you within two business days to find a convenient time. |
...
> "We give free estimate and free design. Our sale consultants are designers. They have degrees in landscaping and hardscaping, so they are professional designers." — Jérôme Besnard, Sales Manager
